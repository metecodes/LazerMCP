...
def main():
    ...
    try:
        ...
        assert data['editable'] and data['primitives'][0]['w'] == 80
        ...
        print('PASS: exact production editor asset; public domain returns bundled SVG, editable parts, 24-hour expiry and editor page')
    finally:

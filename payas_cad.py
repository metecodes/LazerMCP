...
def create_design(
    ...
    extra = {
        ...
        "mechanisms": (built.get("review") or {}).get("mechanisms"),
        "hardware_fit": built.get("hardware_fit") or (built.get("review") or {}).get("hardware_fit"),
        ...
        return _mcp(
            {
                "source": "primitives",
                "assembly": report,
                "tab_slot_debug": report.get("tab_slot_debug") or [],
                "pipeline": built.get("pipeline"),
                "review": built.get("review"),
                "mechanisms": (built.get("review") or {}).get("mechanisms"),
                "hardware_fit": built.get("hardware_fit") or (built.get("review") or {}).get("hardware_fit"),
    ...
    return _mcp(
        {
            ...
            "tab_slot_debug": (svg_report.get("assembly") or {}).get("tab_slot_debug") or [],
            "nesting": svg_report.get("nesting"),
            "topology": svg_report.get("topology"),
            "review": svg_report.get("review") or sidecar,
            "mechanisms": (svg_report.get("review") or sidecar).get("mechanisms"),
            "hardware_fit": svg_report.get("hardware_fit") or (svg_report.get("review") or sidecar).get("hardware_fit"),

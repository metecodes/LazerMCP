...
ICONS: dict[str, list[list[tuple[float, float]]]] = {
    ...
    "star": [_star()],
    "heart": [_heart()],
    "apple": [[(0.50,0.18),(0.68,0.24),(0.78,0.42),(0.74,0.68),(0.60,0.84),(0.50,0.80),(0.40,0.84),(0.26,0.68),(0.22,0.42),(0.32,0.24),(0.50,0.18)],[(0.50,0.18),(0.56,0.05)],[(0.55,0.12),(0.72,0.08),(0.62,0.20)]],
    "ball": [_circle(0.5,0.5,0.38),[(0.12,0.50),(0.88,0.50)],[(0.50,0.12),(0.50,0.88)]],
    "cat": [[(0.20,0.38),(0.22,0.16),(0.38,0.28),(0.50,0.22),(0.62,0.28),(0.78,0.16),(0.80,0.52),(0.72,0.78),(0.50,0.88),(0.28,0.78),(0.20,0.52),(0.20,0.38)],[(0.36,0.48),(0.40,0.48)],[(0.60,0.48),(0.64,0.48)],[(0.44,0.62),(0.50,0.66),(0.56,0.62)]],
}

...
DEFAULTS={
 ...
 'ENGRAVE':{'mode':'surface_engrave','speed_scale':0.65,'power_scale':0.25,'passes':1,'through_cut':False},
...
def resolve_operation_settings(parameters=None):
    ...
    if not 0<engrave['speed_scale']<=1:raise ValueError('ENGRAVE speed_scale must be >0 and <=1')
